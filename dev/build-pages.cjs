...
const files=['index.html','campaign-manager-ui.js','app.js','local-ui.js','styles.css','brand-overrides.css','CNAME','comparison-arrow.json','report-loader.json','toaster.json','gear.svg','hurtz-logo.png','hurtz-tiktok-collector.zip'];
