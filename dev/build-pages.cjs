...
const files=['index.html','campaign-manager-ui.js','overview-campaign.js','app.js','report-layout-upgrade.js','local-ui.js','styles.css','brand-overrides.css','task-kanban.css','CNAME','comparison-arrow.json','report-loader.json','toaster.json','gear.svg','hurtz-logo.png','hurtz-report-logo.png','hurtz-tiktok-collector.zip'];
