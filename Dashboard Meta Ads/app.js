...
function updateTaskFilterState(){
  const selectors=['#taskProjectFilter','#taskModuleFilter','#taskCycleFilter','#taskPriorityFilter','#taskAssigneeFilter'],active=selectors.filter(selector=>document.querySelector(selector)?.value).length,target=document.querySelector('#taskActiveFilterCount'),clear=document.querySelector('#taskClearFilters');
...
async function initializeNativeTasks(){
  ...
  document.querySelector('#taskClearFilters').onclick=()=>{['#taskProjectFilter','#taskModuleFilter','#taskCycleFilter','#taskPriorityFilter','#taskAssigneeFilter'].forEach(selector=>document.querySelector(selector).value='');renderNativeTasks()};
