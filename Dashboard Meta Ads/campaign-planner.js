...
function localOllama(url){try{const target=new URL(url);return target.protocol==='http:'&&['127.0.0.1','localhost','::1'].includes(target.hostname.replace(/^\[|\]$/g,''));}catch{return false;}}
