# Tasks: Recuperar sessão dos relatórios

- [x] T001 Registrar a especificação e critérios de aceitação.
- [x] T002 Implementar espera compartilhada de autenticação.
- [x] T003 Repetir uma vez as chamadas protegidas recusadas.
