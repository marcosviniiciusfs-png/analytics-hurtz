...
(async()=>{
 ...
 try{
  ...
  await page.route('**/api/ads-manager/plan?*',r=>{plans.push(r.request().url());return json(r,{draft:{name:'Campanha loja',destination:'site',page:'1',url:'https://example.com',dailyBudget:40,countries:['BR'],ageMin:25,ageMax:45,headline:'Conheça a loja',message:'Nossa oferta',rationale:'Teste'}})});
